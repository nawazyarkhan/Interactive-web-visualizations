//home work
// Using D3 library to read the sample.json

//const sample="samples.json"

const dataPromise_sample=d3.json("data/samples.json");

console.log("Data Promise: ", dataPromise_sample);

function showD(data) {
    console.log(data);
}

d3.json("data/samples.json").then(showD)
